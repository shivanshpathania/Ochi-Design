...
function Footer() {
  return (
    <div className='w-full h-screen bg-zinc-800 py-20 px-20 flex'>
      <div className="w-1/2  h-full flex flex-col justify-between font-['Founders Grotesk X-Condensed']">
      <div className='heading'>
      <h1 className='uppercase text-8xl tracking-tighter font-bold leading-none -mb-4'>eye-</h1>
      <h1 className='uppercase text-8xl tracking-tighter font-bold leading-none'>opening</h1>
      </div>
      <svg
          width="72"
          height="30"
      ...
      <h1 className='uppercase text-7xl font-bold tracking-tighter'>presentations</h1>
      <div className='dets text-2xl flex flex-col gap-5 mt-10'>
        <a href="">Instagram</a>
        <a href="">Behance</a>
        <a href="">Facebook</a>
        <a href="">LinkedIn</a>
